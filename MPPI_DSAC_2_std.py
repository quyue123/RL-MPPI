...
dataFrame_MD2_316_6 = pd.DataFrame(zip(Method, Return, Samples, Time, Std, Horizon, Iteration),\
...
dataFrame_MD2_316_6 .to_csv("/root/quyue/data/dataFrame_MD2_316_6_stdx2.csv",index=False,sep=',')
# return 曲线
5
# A = []
# score = 0
