...
num_samples = 316     #316  #32 #100   #   316 #32 #10 # 5 #12    #5 # 12  # sample number of DSAC policy and CEM policy
num_elites=250                                  #6#4          #2
temperature = 1
momentum = 0.1
MPPI_iter = 4
STD = 0.5
...
dataFrame_MD2_316 = pd.DataFrame(zip(Method, Return, Samples, Time, Std, Horizon, Iteration,tem,Z),\
                    columns = ['Method', 'Return', 'Samples', 'Time', 'Std', 'Horizon', 'Iteration','tem','Z'])
...
print(dataFrame_MD2_316 )
dataFrame_MD2_316 .to_csv("/root/quyue/data/dataFrame_MD2_316_Zggg_250.csv",index=False,sep=',')
# return 曲线
5
# A = []
# score = 0
