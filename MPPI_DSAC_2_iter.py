...
dataFrame_MD2_316 = pd.DataFrame(zip(Method, Return, Samples, Time, Std, Horizon, Iteration,tem),\
...
dataFrame_MD2_316 .to_csv("/root/quyue/data/dataFrame_MD2_316_iter1.csv",index=False,sep=',')
# return 曲线
5
# A = []
# score = 0
